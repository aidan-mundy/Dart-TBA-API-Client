...
abstract class MatchScoreBreakdown2017Alliance
    implements Built<MatchScoreBreakdown2017Alliance, MatchScoreBreakdown2017AllianceBuilder> {
  ...
  factory MatchScoreBreakdown2017Alliance([void updates(MatchScoreBreakdown2017AllianceBuilder b)]) =
...
class _$MatchScoreBreakdown2017AllianceSerializer implements StructuredSerializer<MatchScoreBreakdown2017Alliance> {
  ...
  Iterable<Object?> serialize(Serializers serializers, MatchScoreBreakdown2017Alliance object,
    ...
    if (object.rotor1Auto != null) {
      result..add(r'rotor1Auto')..add(serializers.serialize(object.rotor1Auto, specifiedType: const FullType(bool)));
    }
    if (object.rotor2Auto != null) {
      result..add(r'rotor2Auto')..add(serializers.serialize(object.rotor2Auto, specifiedType: const FullType(bool)));
    }
    if (object.autoFuelLow != null) {
      result..add(r'autoFuelLow')..add(serializers.serialize(object.autoFuelLow, specifiedType: const FullType(int)));
    }
    if (object.autoFuelHigh != null) {
      result..add(r'autoFuelHigh')..add(serializers.serialize(object.autoFuelHigh, specifiedType: const FullType(int)));
    }
    if (object.autoMobilityPoints != null) {
      result
        ..add(r'autoMobilityPoints')
        ..add(serializers.serialize(object.autoMobilityPoints, specifiedType: const FullType(int)));
    }
    if (object.autoRotorPoints != null) {
      result
        ..add(r'autoRotorPoints')
        ..add(serializers.serialize(object.autoRotorPoints, specifiedType: const FullType(int)));
    }
    if (object.autoFuelPoints != null) {
      result
        ..add(r'autoFuelPoints')
        ..add(serializers.serialize(object.autoFuelPoints, specifiedType: const FullType(int)));
    }
    if (object.teleopFuelPoints != null) {
      result
        ..add(r'teleopFuelPoints')
        ..add(serializers.serialize(object.teleopFuelPoints, specifiedType: const FullType(int)));
    }
    if (object.teleopFuelLow != null) {
      result
        ..add(r'teleopFuelLow')
        ..add(serializers.serialize(object.teleopFuelLow, specifiedType: const FullType(int)));
    }
    if (object.teleopFuelHigh != null) {
      result
        ..add(r'teleopFuelHigh')
        ..add(serializers.serialize(object.teleopFuelHigh, specifiedType: const FullType(int)));
    }
    if (object.teleopRotorPoints != null) {
      result
        ..add(r'teleopRotorPoints')
        ..add(serializers.serialize(object.teleopRotorPoints, specifiedType: const FullType(int)));
    }
    if (object.kPaRankingPointAchieved != null) {
      result
        ..add(r'kPaRankingPointAchieved')
        ..add(serializers.serialize(object.kPaRankingPointAchieved, specifiedType: const FullType(bool)));
    }
    if (object.teleopTakeoffPoints != null) {
      result
        ..add(r'teleopTakeoffPoints')
        ..add(serializers.serialize(object.teleopTakeoffPoints, specifiedType: const FullType(int)));
    }
    if (object.kPaBonusPoints != null) {
      result
        ..add(r'kPaBonusPoints')
        ..add(serializers.serialize(object.kPaBonusPoints, specifiedType: const FullType(int)));
    }
    if (object.rotorBonusPoints != null) {
      result
        ..add(r'rotorBonusPoints')
        ..add(serializers.serialize(object.rotorBonusPoints, specifiedType: const FullType(int)));
    }
    if (object.rotor1Engaged != null) {
      result
        ..add(r'rotor1Engaged')
        ..add(serializers.serialize(object.rotor1Engaged, specifiedType: const FullType(bool)));
    }
    if (object.rotor2Engaged != null) {
      result
        ..add(r'rotor2Engaged')
        ..add(serializers.serialize(object.rotor2Engaged, specifiedType: const FullType(bool)));
    }
    if (object.rotor3Engaged != null) {
      result
        ..add(r'rotor3Engaged')
        ..add(serializers.serialize(object.rotor3Engaged, specifiedType: const FullType(bool)));
    }
    if (object.rotor4Engaged != null) {
      result
        ..add(r'rotor4Engaged')
        ..add(serializers.serialize(object.rotor4Engaged, specifiedType: const FullType(bool)));
    }
    if (object.rotorRankingPointAchieved != null) {
      result
        ..add(r'rotorRankingPointAchieved')
        ..add(serializers.serialize(object.rotorRankingPointAchieved, specifiedType: const FullType(bool)));
    }
    ...
    if (object.touchpadNear != null) {
      result
        ..add(r'touchpadNear')
        ..add(serializers.serialize(object.touchpadNear, specifiedType: const FullType(String)));
    }
    if (object.touchpadMiddle != null) {
      result
        ..add(r'touchpadMiddle')
        ..add(serializers.serialize(object.touchpadMiddle, specifiedType: const FullType(String)));
    }
    if (object.touchpadFar != null) {
      result
        ..add(r'touchpadFar')
        ..add(serializers.serialize(object.touchpadFar, specifiedType: const FullType(String)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case r'robot3Auto':
          ...
          break;
        case r'rotor1Auto':
          result.rotor1Auto = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'rotor2Auto':
          result.rotor2Auto = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'autoFuelLow':
          result.autoFuelLow = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoFuelHigh':
          result.autoFuelHigh = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoMobilityPoints':
          result.autoMobilityPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoRotorPoints':
          result.autoRotorPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoFuelPoints':
          result.autoFuelPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopFuelPoints':
          result.teleopFuelPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopFuelLow':
          result.teleopFuelLow = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopFuelHigh':
          result.teleopFuelHigh = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopRotorPoints':
          result.teleopRotorPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'kPaRankingPointAchieved':
          result.kPaRankingPointAchieved = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'teleopTakeoffPoints':
          result.teleopTakeoffPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'kPaBonusPoints':
          result.kPaBonusPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'rotorBonusPoints':
          result.rotorBonusPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'rotor1Engaged':
          result.rotor1Engaged = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'rotor2Engaged':
          result.rotor2Engaged = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'rotor3Engaged':
          result.rotor3Engaged = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'rotor4Engaged':
          result.rotor4Engaged = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'rotorRankingPointAchieved':
          result.rotorRankingPointAchieved =
        ...
        case r'foulCount':
          ...
          break;
        case r'touchpadNear':
          result.touchpadNear = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'touchpadMiddle':
          result.touchpadMiddle = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'touchpadFar':
          result.touchpadFar = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
      }
    }
    return result.build();
...
class MatchScoreBreakdown2017AllianceRobot1AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2017AllianceRobot1AutoEnum> get serializer =>
...
class MatchScoreBreakdown2017AllianceRobot2AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2017AllianceRobot2AutoEnum> get serializer =>
...
class MatchScoreBreakdown2017AllianceRobot3AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2017AllianceRobot3AutoEnum> get serializer =>
