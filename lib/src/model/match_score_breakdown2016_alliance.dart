...
abstract class MatchScoreBreakdown2016Alliance
    implements Built<MatchScoreBreakdown2016Alliance, MatchScoreBreakdown2016AllianceBuilder> {
  ...
  factory MatchScoreBreakdown2016Alliance([void updates(MatchScoreBreakdown2016AllianceBuilder b)]) =
...
class _$MatchScoreBreakdown2016AllianceSerializer implements StructuredSerializer<MatchScoreBreakdown2016Alliance> {
  ...
  Iterable<Object?> serialize(Serializers serializers, MatchScoreBreakdown2016Alliance object,
    ...
    if (object.breachPoints != null) {
      result..add(r'breachPoints')..add(serializers.serialize(object.breachPoints, specifiedType: const FullType(int)));
    }
    ...
    if (object.capturePoints != null) {
      result
        ..add(r'capturePoints')
        ..add(serializers.serialize(object.capturePoints, specifiedType: const FullType(int)));
    }
    ...
    if (object.autoReachPoints != null) {
      result
        ...
        ..add(serializers.serialize(object.autoReachPoints, specifiedType: const FullType(int)));
    }
    if (object.autoCrossingPoints != null) {
      result
        ..add(r'autoCrossingPoints')
        ..add(serializers.serialize(object.autoCrossingPoints, specifiedType: const FullType(int)));
    }
    if (object.autoBouldersLow != null) {
      result
        ..add(r'autoBouldersLow')
        ..add(serializers.serialize(object.autoBouldersLow, specifiedType: const FullType(int)));
    }
    if (object.autoBouldersHigh != null) {
      result
        ..add(r'autoBouldersHigh')
        ..add(serializers.serialize(object.autoBouldersHigh, specifiedType: const FullType(int)));
    }
    if (object.autoBoulderPoints != null) {
      result
        ..add(r'autoBoulderPoints')
        ..add(serializers.serialize(object.autoBoulderPoints, specifiedType: const FullType(int)));
    }
    if (object.teleopCrossingPoints != null) {
      result
        ..add(r'teleopCrossingPoints')
        ..add(serializers.serialize(object.teleopCrossingPoints, specifiedType: const FullType(int)));
    }
    if (object.teleopBouldersLow != null) {
      result
        ..add(r'teleopBouldersLow')
        ..add(serializers.serialize(object.teleopBouldersLow, specifiedType: const FullType(int)));
    }
    if (object.teleopBouldersHigh != null) {
      result
        ..add(r'teleopBouldersHigh')
        ..add(serializers.serialize(object.teleopBouldersHigh, specifiedType: const FullType(int)));
    }
    if (object.teleopBoulderPoints != null) {
      result
        ..add(r'teleopBoulderPoints')
        ..add(serializers.serialize(object.teleopBoulderPoints, specifiedType: const FullType(int)));
    }
    if (object.teleopDefensesBreached != null) {
      result
        ..add(r'teleopDefensesBreached')
        ..add(serializers.serialize(object.teleopDefensesBreached, specifiedType: const FullType(bool)));
    }
    if (object.teleopChallengePoints != null) {
      result
        ..add(r'teleopChallengePoints')
        ..add(serializers.serialize(object.teleopChallengePoints, specifiedType: const FullType(int)));
    }
    if (object.teleopScalePoints != null) {
      result
        ..add(r'teleopScalePoints')
        ..add(serializers.serialize(object.teleopScalePoints, specifiedType: const FullType(int)));
    }
    if (object.teleopTowerCaptured != null) {
      result
        ..add(r'teleopTowerCaptured')
        ..add(serializers.serialize(object.teleopTowerCaptured, specifiedType: const FullType(int)));
    }
    if (object.towerFaceA != null) {
      result..add(r'towerFaceA')..add(serializers.serialize(object.towerFaceA, specifiedType: const FullType(String)));
    }
    if (object.towerFaceB != null) {
      result..add(r'towerFaceB')..add(serializers.serialize(object.towerFaceB, specifiedType: const FullType(String)));
    }
    if (object.towerFaceC != null) {
      result..add(r'towerFaceC')..add(serializers.serialize(object.towerFaceC, specifiedType: const FullType(String)));
    }
    if (object.towerEndStrength != null) {
      result
        ..add(r'towerEndStrength')
        ..add(serializers.serialize(object.towerEndStrength, specifiedType: const FullType(int)));
    }
    ...
    if (object.position2 != null) {
      result..add(r'position2')..add(serializers.serialize(object.position2, specifiedType: const FullType(String)));
    }
    if (object.position3 != null) {
      result..add(r'position3')..add(serializers.serialize(object.position3, specifiedType: const FullType(String)));
    }
    if (object.position4 != null) {
      result..add(r'position4')..add(serializers.serialize(object.position4, specifiedType: const FullType(String)));
    }
    if (object.position5 != null) {
      result..add(r'position5')..add(serializers.serialize(object.position5, specifiedType: const FullType(String)));
    }
    if (object.position1crossings != null) {
      result
        ..add(r'position1crossings')
        ..add(serializers.serialize(object.position1crossings, specifiedType: const FullType(int)));
    }
    if (object.position2crossings != null) {
      result
        ..add(r'position2crossings')
        ..add(serializers.serialize(object.position2crossings, specifiedType: const FullType(int)));
    }
    if (object.position3crossings != null) {
      result
        ..add(r'position3crossings')
        ..add(serializers.serialize(object.position3crossings, specifiedType: const FullType(int)));
    }
    if (object.position4crossings != null) {
      result
        ..add(r'position4crossings')
        ..add(serializers.serialize(object.position4crossings, specifiedType: const FullType(int)));
    }
    if (object.position5crossings != null) {
      result
        ..add(r'position5crossings')
        ..add(serializers.serialize(object.position5crossings, specifiedType: const FullType(int)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case r'teleopPoints':
          ...
          break;
        case r'breachPoints':
          result.breachPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'foulPoints':
          result.foulPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'capturePoints':
          result.capturePoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'adjustPoints':
        ...
        case r'autoReachPoints':
          result.autoReachPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoCrossingPoints':
          result.autoCrossingPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoBouldersLow':
          result.autoBouldersLow = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoBouldersHigh':
          result.autoBouldersHigh = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'autoBoulderPoints':
          result.autoBoulderPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopCrossingPoints':
          result.teleopCrossingPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopBouldersLow':
          result.teleopBouldersLow = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopBouldersHigh':
          result.teleopBouldersHigh = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopBoulderPoints':
          result.teleopBoulderPoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopDefensesBreached':
          result.teleopDefensesBreached = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case r'teleopChallengePoints':
          result.teleopChallengePoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopScalePoints':
          result.teleopScalePoints = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'teleopTowerCaptured':
          result.teleopTowerCaptured = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'towerFaceA':
          result.towerFaceA = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'towerFaceB':
          result.towerFaceB = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'towerFaceC':
          result.towerFaceC = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'towerEndStrength':
          result.towerEndStrength = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        ...
        case r'foulCount':
          ...
          break;
        case r'position2':
          result.position2 = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'position3':
          result.position3 = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'position4':
          result.position4 = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'position5':
          result.position5 = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'position1crossings':
          result.position1crossings = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'position2crossings':
          result.position2crossings = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'position3crossings':
          result.position3crossings = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'position4crossings':
          result.position4crossings = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'position5crossings':
          result.position5crossings = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
      }
    }
    return result.build();
...
class MatchScoreBreakdown2016AllianceRobot1AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2016AllianceRobot1AutoEnum> get serializer =>
...
class MatchScoreBreakdown2016AllianceRobot2AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2016AllianceRobot2AutoEnum> get serializer =>
...
class MatchScoreBreakdown2016AllianceRobot3AutoEnum extends EnumClass {
  ...
  static Serializer<MatchScoreBreakdown2016AllianceRobot3AutoEnum> get serializer =>
