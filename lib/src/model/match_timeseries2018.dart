...
class _$MatchTimeseries2018Serializer implements StructuredSerializer<MatchTimeseries2018> {
  ...
  Iterable<Object?> serialize(Serializers serializers, MatchTimeseries2018 object,
    ...
    if (object.matchId != null) {
      result..add(r'match_id')..add(serializers.serialize(object.matchId, specifiedType: const FullType(String)));
    }
    if (object.mode != null) {
      result..add(r'mode')..add(serializers.serialize(object.mode, specifiedType: const FullType(String)));
    }
    if (object.play != null) {
      result..add(r'play')..add(serializers.serialize(object.play, specifiedType: const FullType(int)));
    }
    if (object.timeRemaining != null) {
      result
        ..add(r'time_remaining')
        ..add(serializers.serialize(object.timeRemaining, specifiedType: const FullType(int)));
    }
    if (object.blueAutoQuest != null) {
      result
        ..add(r'blue_auto_quest')
        ..add(serializers.serialize(object.blueAutoQuest, specifiedType: const FullType(int)));
    }
    if (object.blueBoostCount != null) {
      result
        ..add(r'blue_boost_count')
        ..add(serializers.serialize(object.blueBoostCount, specifiedType: const FullType(int)));
    }
    if (object.blueBoostPlayed != null) {
      result
        ..add(r'blue_boost_played')
        ..add(serializers.serialize(object.blueBoostPlayed, specifiedType: const FullType(int)));
    }
    if (object.blueCurrentPowerup != null) {
      result
        ..add(r'blue_current_powerup')
        ..add(serializers.serialize(object.blueCurrentPowerup, specifiedType: const FullType(String)));
    }
    if (object.blueFaceTheBoss != null) {
      result
        ..add(r'blue_face_the_boss')
        ..add(serializers.serialize(object.blueFaceTheBoss, specifiedType: const FullType(int)));
    }
    if (object.blueForceCount != null) {
      result
        ..add(r'blue_force_count')
        ..add(serializers.serialize(object.blueForceCount, specifiedType: const FullType(int)));
    }
    if (object.blueForcePlayed != null) {
      result
        ..add(r'blue_force_played')
        ..add(serializers.serialize(object.blueForcePlayed, specifiedType: const FullType(int)));
    }
    if (object.blueLevitateCount != null) {
      result
        ..add(r'blue_levitate_count')
        ..add(serializers.serialize(object.blueLevitateCount, specifiedType: const FullType(int)));
    }
    if (object.blueLevitatePlayed != null) {
      result
        ..add(r'blue_levitate_played')
        ..add(serializers.serialize(object.blueLevitatePlayed, specifiedType: const FullType(int)));
    }
    if (object.bluePowerupTimeRemaining != null) {
      result
        ..add(r'blue_powerup_time_remaining')
        ..add(serializers.serialize(object.bluePowerupTimeRemaining, specifiedType: const FullType(String)));
    }
    if (object.blueScaleOwned != null) {
      result
        ..add(r'blue_scale_owned')
        ..add(serializers.serialize(object.blueScaleOwned, specifiedType: const FullType(int)));
    }
    if (object.blueScore != null) {
      result..add(r'blue_score')..add(serializers.serialize(object.blueScore, specifiedType: const FullType(int)));
    }
    if (object.blueSwitchOwned != null) {
      result
        ..add(r'blue_switch_owned')
        ..add(serializers.serialize(object.blueSwitchOwned, specifiedType: const FullType(int)));
    }
    if (object.redAutoQuest != null) {
      result
        ..add(r'red_auto_quest')
        ..add(serializers.serialize(object.redAutoQuest, specifiedType: const FullType(int)));
    }
    if (object.redBoostCount != null) {
      result
        ..add(r'red_boost_count')
        ..add(serializers.serialize(object.redBoostCount, specifiedType: const FullType(int)));
    }
    if (object.redBoostPlayed != null) {
      result
        ..add(r'red_boost_played')
        ..add(serializers.serialize(object.redBoostPlayed, specifiedType: const FullType(int)));
    }
    if (object.redCurrentPowerup != null) {
      result
        ..add(r'red_current_powerup')
        ..add(serializers.serialize(object.redCurrentPowerup, specifiedType: const FullType(String)));
    }
    if (object.redFaceTheBoss != null) {
      result
        ..add(r'red_face_the_boss')
        ..add(serializers.serialize(object.redFaceTheBoss, specifiedType: const FullType(int)));
    }
    if (object.redForceCount != null) {
      result
        ..add(r'red_force_count')
        ..add(serializers.serialize(object.redForceCount, specifiedType: const FullType(int)));
    }
    if (object.redForcePlayed != null) {
      result
        ..add(r'red_force_played')
        ..add(serializers.serialize(object.redForcePlayed, specifiedType: const FullType(int)));
    }
    if (object.redLevitateCount != null) {
      result
        ..add(r'red_levitate_count')
        ..add(serializers.serialize(object.redLevitateCount, specifiedType: const FullType(int)));
    }
    if (object.redLevitatePlayed != null) {
      result
        ..add(r'red_levitate_played')
        ..add(serializers.serialize(object.redLevitatePlayed, specifiedType: const FullType(int)));
    }
    if (object.redPowerupTimeRemaining != null) {
      result
        ..add(r'red_powerup_time_remaining')
        ..add(serializers.serialize(object.redPowerupTimeRemaining, specifiedType: const FullType(String)));
    }
    if (object.redScaleOwned != null) {
      result
        ..add(r'red_scale_owned')
        ..add(serializers.serialize(object.redScaleOwned, specifiedType: const FullType(int)));
    }
    if (object.redScore != null) {
      result..add(r'red_score')..add(serializers.serialize(object.redScore, specifiedType: const FullType(int)));
    }
    if (object.redSwitchOwned != null) {
      result
        ..add(r'red_switch_owned')
        ..add(serializers.serialize(object.redSwitchOwned, specifiedType: const FullType(int)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case r'event_key':
          ...
          break;
        case r'match_id':
          result.matchId = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'mode':
          result.mode = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'play':
          result.play = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'time_remaining':
          result.timeRemaining = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_auto_quest':
          result.blueAutoQuest = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_boost_count':
          result.blueBoostCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_boost_played':
          result.blueBoostPlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_current_powerup':
          result.blueCurrentPowerup = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'blue_face_the_boss':
          result.blueFaceTheBoss = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_force_count':
          result.blueForceCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_force_played':
          result.blueForcePlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_levitate_count':
          result.blueLevitateCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_levitate_played':
          result.blueLevitatePlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_powerup_time_remaining':
          result.bluePowerupTimeRemaining =
              serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'blue_scale_owned':
          result.blueScaleOwned = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_score':
          result.blueScore = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'blue_switch_owned':
          result.blueSwitchOwned = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_auto_quest':
          result.redAutoQuest = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_boost_count':
          result.redBoostCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_boost_played':
          result.redBoostPlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_current_powerup':
          result.redCurrentPowerup = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'red_face_the_boss':
          result.redFaceTheBoss = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_force_count':
          result.redForceCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_force_played':
          result.redForcePlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_levitate_count':
          result.redLevitateCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_levitate_played':
          result.redLevitatePlayed = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_powerup_time_remaining':
          result.redPowerupTimeRemaining =
              serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'red_scale_owned':
          result.redScaleOwned = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_score':
          result.redScore = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'red_switch_owned':
          result.redSwitchOwned = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
      }
    }
    return result.build();
