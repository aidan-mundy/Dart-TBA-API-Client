...
Serializers serializers = (_$serializers.toBuilder()
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(APIStatusAppVersion)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EliminationAlliance)]),
          () => new ListBuilder<EliminationAlliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EliminationAllianceBackup)]),
          () => new ListBuilder<EliminationAllianceBackup>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EliminationAllianceStatus)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EventDistrictPoints)]),
          () => new ListBuilder<EventDistrictPoints>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EventDistrictPointsPoints)]),
          () => new ListBuilder<EventDistrictPointsPoints>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(EventDistrictPointsTiebreakers)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2015)]),
          () => new ListBuilder<MatchScoreBreakdown2015>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(MatchScoreBreakdown2015Alliance)]),
          () => new ListBuilder<MatchScoreBreakdown2015Alliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2016)]),
          () => new ListBuilder<MatchScoreBreakdown2016>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(MatchScoreBreakdown2016Alliance)]),
          () => new ListBuilder<MatchScoreBreakdown2016Alliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2017)]),
          () => new ListBuilder<MatchScoreBreakdown2017>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(MatchScoreBreakdown2017Alliance)]),
          () => new ListBuilder<MatchScoreBreakdown2017Alliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2018)]),
          () => new ListBuilder<MatchScoreBreakdown2018>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(MatchScoreBreakdown2018Alliance)]),
          () => new ListBuilder<MatchScoreBreakdown2018Alliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2019)]),
          () => new ListBuilder<MatchScoreBreakdown2019>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(MatchScoreBreakdown2019Alliance)]),
          () => new ListBuilder<MatchScoreBreakdown2019Alliance>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MatchScoreBreakdown2020)]),
      ...
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(MatchSimple)]), () => new ListBuilder<MatchSimple>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(MatchSimpleAlliances)]), () => new ListBuilder<MatchSimpleAlliances>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(MatchTimeseries2018)]), () => new ListBuilder<MatchTimeseries2018>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(MatchVideos)]), () => new ListBuilder<MatchVideos>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(Media)]), () => new ListBuilder<Media>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(Team)]), () => new ListBuilder<Team>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatus)]), () => new ListBuilder<TeamEventStatus>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusAlliance)]), () => new ListBuilder<TeamEventStatusAlliance>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusAllianceBackup)]), () => new ListBuilder<TeamEventStatusAllianceBackup>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusPlayoff)]), () => new ListBuilder<TeamEventStatusPlayoff>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusRank)]), () => new ListBuilder<TeamEventStatusRank>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusRankRanking)]), () => new ListBuilder<TeamEventStatusRankRanking>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamEventStatusRankSortOrderInfo)]), () => new ListBuilder<TeamEventStatusRankSortOrderInfo>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamRobot)]), () => new ListBuilder<TeamRobot>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(TeamSimple)]), () => new ListBuilder<TeamSimple>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(WLTRecord)]), () => new ListBuilder<WLTRecord>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(Webcast)]), () => new ListBuilder<Webcast>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(Zebra)]), () => new ListBuilder<Zebra>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(ZebraAlliances)]), () => new ListBuilder<ZebraAlliances>())
      ..addBuilderFactory(const FullType(BuiltList, const [const FullType(ZebraTeam)]), () => new ListBuilder<ZebraTeam>())
