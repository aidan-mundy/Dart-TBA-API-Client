...
class TBAMedia {
  ...
  TBAMedia.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    type = json['type'];
  ...
  static List<TBAMedia> listFromJson(List<dynamic> json) {
    return json == null
        ? List<TBAMedia>()
        : json.map((value) => TBAMedia.fromJson(value)).toList();
  }

  static Map<String, TBAMedia> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TBAMedia>();
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic value) => map[key] = TBAMedia.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of Media-objects as value to a dart map
  static Map<String, List<TBAMedia>> mapListFromJson(
      Map<String, dynamic> json) {
    var map = Map<String, List<TBAMedia>>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) {
        map[key] = TBAMedia.listFromJson(value);
      });
    }
    return map;
  }
