...
class TBATeam {
  ...
  TBATeam.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    key = json['key'];
  ...
  static List<TBATeam> listFromJson(List<dynamic> json) {
    return json == null
        ? List<TBATeam>()
        : json.map((value) => TBATeam.fromJson(value)).toList();
  }

  static Map<String, TBATeam> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TBATeam>();
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic value) => map[key] = TBATeam.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of Team-objects as value to a dart map
  static Map<String, List<TBATeam>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<TBATeam>>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) {
        map[key] = TBATeam.listFromJson(value);
      });
    }
    return map;
  }
