...
Serializer<EventRankingRankings> _$eventRankingRankingsSerializer =
    new _$EventRankingRankingsSerializer();
...
class _$EventRankingRankingsSerializer
  ...
  @override
  final String wireName = 'EventRankingRankings';
  ...
  EventRankingRankings deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EventRankingRankingsBuilder();
...
class EventRankingRankingsBuilder
  ...
  EventRankingRankingsBuilder get _$this {
    if (_$v != null) {
      ...
      _extraStats = _$v.extraStats?.toBuilder();
