...
Serializer<TeamEventStatus> _$teamEventStatusSerializer =
    new _$TeamEventStatusSerializer();
...
class _$TeamEventStatusSerializer
  ...
  @override
  final String wireName = 'TeamEventStatus';
  ...
  TeamEventStatus deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new TeamEventStatusBuilder();
...
class TeamEventStatusBuilder
  ...
  TeamEventStatusBuilder get _$this {
    if (_$v != null) {
      _qual = _$v.qual?.toBuilder();
      _alliance = _$v.alliance?.toBuilder();
      _playoff = _$v.playoff?.toBuilder();
      _allianceStatusStr = _$v.allianceStatusStr;
      _playoffStatusStr = _$v.playoffStatusStr;
      _overallStatusStr = _$v.overallStatusStr;
      _nextMatchKey = _$v.nextMatchKey;
      _lastMatchKey = _$v.lastMatchKey;
      _$v = null;
    }
    return this;
  }
