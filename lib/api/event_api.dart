...
class EventApi {
  ...
  Future<Response<Event>> getEvent(
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<Event>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  Future<Response<List<EliminationAlliance>>> getEventAlliances(
    String eventKey, {
    String ifModifiedSince,
    CancelToken cancelToken,
    Map<String, String> headers,
    ...
    String _path = "/event/{event_key}/alliances"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
    ...
    return _dio
      ...
      BuiltList<EliminationAlliance> dataList = _serializers.deserialize(
          response.data is String ? jsonDecode(response.data) : response.data,
          specifiedType: type);
      var data = dataList.toList();
  ...
  Future<Response<List<Award>>> getEventAwards(
    String eventKey, {
    String ifModifiedSince,
    CancelToken cancelToken,
    Map<String, String> headers,
    ...
    String _path = "/event/{event_key}/awards"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
  ...
  Future<Response<EventInsights>> getEventInsights(
    ...
    String _path = "/event/{event_key}/insights"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<EventInsights>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  Future<Response<EventOPRs>> getEventOPRs(
    ...
    String _path = "/event/{event_key}/oprs"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<EventOPRs>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  Future<Response<Object>> getEventPredictions(
    String eventKey, {
    String ifModifiedSince,
    CancelToken cancelToken,
    Map<String, String> headers,
    ...
    String _path = "/event/{event_key}/predictions"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
  ...
  Future<Response<EventRanking>> getEventRankings(
    ...
    String _path = "/event/{event_key}/rankings"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<EventRanking>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  Future<Response<EventSimple>> getEventSimple(
    ...
    String _path = "/event/{event_key}/simple"
        .replaceAll("{" r'event_key' "}", eventKey.toString());
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<EventSimple>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
