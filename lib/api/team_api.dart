...
class TeamApi {
  ...
  ///
  /// Gets a &#x60;Team&#x60; object for the team referenced by the given key.
  Future<TBATeam> getTeam(String teamKey, {String ifModifiedSince}) async {
    Response response =
        await getTeamWithHttpInfo(teamKey, ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'Team')
          as TBATeam;
    } else {
      return null;
    }
  ...
  ///
  /// Gets a list of awards the given team has won.
  Future<List<TBAAward>> getTeamAwards(String teamKey,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of awards the given team has won in a given year.
  Future<List<TBAAward>> getTeamAwardsByYear(String teamKey, int year,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of awards the given team won at the given event.
  Future<List<TBAAward>> getTeamEventAwards(String teamKey, String eventKey,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of all events this team has competed at.
  Future<List<TBAEvent>> getTeamEvents(String teamKey,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of events this team has competed at in the given year.
  Future<List<TBAEvent>> getTeamEventsByYear(String teamKey, int year,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of Media (videos / pictures) for the given team and tag.
  Future<List<TBAMedia>> getTeamMediaByTag(String teamKey, String mediaTag,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of Media (videos / pictures) for the given team, tag and year.
  Future<List<TBAMedia>> getTeamMediaByTagYear(
      String teamKey, String mediaTag, int year,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of Media (videos / pictures) for the given team and year.
  Future<List<TBAMedia>> getTeamMediaByYear(String teamKey, int year,
      {String ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of Media (social media) for the given team.
  Future<List<TBAMedia>> getTeamSocialMedia(String teamKey,
      {String ifModifiedSince}) async {
